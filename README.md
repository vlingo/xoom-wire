...
The VLINGO XOOM platform SDK wire protocol messaging implementations, such as with full-duplex TCP and UDP multicast, and RSocket, using VLINGO/ACTORS.
...
```gradle
dependencies {
    compile 'io.vlingo:vlingo-wire:1.5.0'
}
